...
Convención de datetimes:
  Todas las fechas guardadas en las columnas DateTime (expires_at, created_at, etc.)
  son NAIVE UTC.  Ver auth-multi-user.md para la justificación completa.
"""
import os
