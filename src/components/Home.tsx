  ...
  if (studios === null) {
    return (
      <div className="w-full h-screen flex items-center justify-center" style={{ background: "#0F1117" }}>
        <Loader2 className="animate-spin" size={32} style={{ color: "#565C70" }} />
      </div>
    );
  }
      ...
      {isEmpty ? (
          ...
          <div style={{ maxWidth: 1000 }}>
            <div
              style={{
                ...
                color: "#C4847A", marginBottom: 12,
              }}
            >
              Huginn
            </div>
            <h1 style={{ margin: 0, fontSize: 32, fontWeight: 700, letterSpacing: "-0.025em", color: "#E6E9F1" }}>
              Studios
            </h1>
          </div>
          ...
          >
            <span
              style={{
                ...
                background: "#1A1D27", border: "1px solid #272C3A",
                display: "inline-flex", alignItems: "center", justifyContent: "center",
                color: "#C4847A", marginBottom: 14,
              }}
            >
            ...
            <div style={{ fontSize: 19, fontWeight: 600, color: "#E6E9F1", letterSpacing: "-0.01em" }}>
              Todavía no creaste ningún Estudio
            </div>
            <p style={{ margin: "6px 0 26px", fontSize: 13.5, lineHeight: 1.6, color: "#565C70", maxWidth: 380 }}>
        ...
        >
          <div style={{ maxWidth: 1000 }}>
            ...
            <p style={{ margin: "9px 0 38px", fontSize: 13.5, color: "#565C70", maxWidth: 560, lineHeight: 1.55 }}>
            ...
            >
              {studios.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontSize: 15, fontWeight: 600, color: "#E6E9F1", letterSpacing: "-0.005em" }}>
                      {s.name}
                    </span>
                  </div>
                );
              ...
              >
                <span
                  style={{
                    width: 42, height: 42, borderRadius: 11,
                    background: "#232838", border: "1px solid #272C3A",
                    display: "inline-flex", alignItems: "center", justifyContent: "center",
                    color: "#C4847A",
                  }}
                >
                ...
                <span>
                  <span style={{ display: "block", fontSize: 14, fontWeight: 600, color: "#E6E9F1" }}>
                    Nuevo Estudio
                  </span>
                  <span style={{ display: "block", marginTop: 3, fontSize: 11.5, color: "#565C70" }}>
                    Se crea vacío.
                  </span>
                </span>
              </button>
