                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className="text-white/80 text-sm font-medium truncate">{b.name}</span>
                    </div>
                    {/* Three-dot menu */}
                  ...
                  <span className="text-white/25 text-xs">{relativeTime(b.updated_at)}</span>
                </div>
              ))}
            </div>
          )}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {folders.map((f) => (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    <FolderIcon size={14} className="text-white/30 shrink-0" />
                    <span className="text-white/80 text-sm font-medium truncate">{f.name}</span>
                  </div>
                  {/* Three-dot menu */}
                  <div data-menu-root="true" style={{ position: "relative" }} className="shrink-0">
                    <button
                ...
                <span className="text-white/25 text-xs">Carpeta</span>
              </div>
            ))}
            ...
            >
              ...
              <span className="text-white/30 text-sm font-medium">Nueva Carpeta</span>
            </button>
          </div>
        </section>
      </div>
